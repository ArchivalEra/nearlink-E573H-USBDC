...
### 📚 Intel library (25 research docs)
Full NearLink protocol deep-dives: SSAP dialect comparison (**OHOS = same wire protocol as device firmware — port path proven**), connection manager, data plane (DTAP/SDR), security pairing, ranging, standard params (SLE 12Mbps/250µs/256 users), plus 6 OpenSparklink contract reports (DLI/UAPI/CONN-FSM/SSAP/PHY/USB transport).
...
└── .scratch/            # wayfinder decision map + 25 research docs + shifu list
```
...
| `.scratch/nearlink-driver/lab-notes/` | **25 research docs** (SSAP dialect/CM/DTAP/SDR/SM/HADM/standard/OSPL…) | zh+en |
