...
/* Error codes for ERROR_RSP / WRITE_RSP error items. Values match
 * SSAP_PduErrCode_E in ssap_pkt.h (OHOS). */
enum {
    SSAP_ERRCODE_SUCCESS = 0x0,
    SSAP_ERRCODE_INVALID_PDU,
    SSAP_ERRCODE_UNSUPPORT_PDU,
    SSAP_ERRCODE_UNKNOWN,
    SSAP_ERRCODE_INVALID_HANDLE,
    SSAP_ERRCODE_NO_RESOURCE,
    SSAP_ERRCODE_FORBID_READ,
    SSAP_ERRCODE_FORBID_WRITE,
    SSAP_ERRCODE_UNAUTHENTICATED,
